...
//    {
//        $source = str_replace('<?php', '', strip_tags($this->templateSource));
//        $pattern = '/{{ *([a-zA-Z_]{1,20})(\.[a-zA-Z_]{1,20})* *}}/';
//        $replacement = '<?php echo isset($v[\'$1.###$2\']) ? $v[\'$1.###$2\'] : $d; ? >';
//        $this->cleanedSource = str_replace('.###.', "']['", preg_replace($pattern, $replacement, $source));
//        echo $this->cleanedSource; exit;
//        return $this;
//    }
